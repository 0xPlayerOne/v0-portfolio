// Inline brand SVG icons — lucide-react 1.x removed brand icons (Github, Linkedin, Twitter).
// These are minimal inline replacements so the UI keeps working without a new dependency.
