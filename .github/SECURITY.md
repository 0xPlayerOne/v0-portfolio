...
1. **Discord** — DM NiftyAndy (`0xPlayerOne`) directly in the [V0 Portfolio Discord](https://discord.gg/niftyleague)
...
- The reporter and the V0 Portfolio team coordinate disclosure.
...
This policy covers all code in the `0xPlayerOne/v0-portfolio` repository, including all apps and packages within the monorepo.  
