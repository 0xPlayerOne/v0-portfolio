...
For V0 Portfolio team members and automation agents.
...
For open-source contributors outside V0 Portfolio.
...
```bash
git clone git@github.com:YOUR_USERNAME/v0-portfolio.git
cd v0-portfolio
```
...
```bash
git remote add upstream git@github.com:0xPlayerOne/v0-portfolio.git
git fetch upstream
