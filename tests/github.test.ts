...
describe("GitHub project loading", () => {
  ...
  it("combines pinned and popular repositories and calculates languages", async () => {
    ...
    expect(projects[2]).toMatchObject({ title: "Popular Tool", isPinned: false })
